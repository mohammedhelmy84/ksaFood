        ...
        <div class="container-fluid py-1 px-3">
          <nav aria-label="breadcrumb">
            <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
              ...
              <li class="breadcrumb-item text-sm text-dark active" aria-current="page">Orders Report</li>
            </ol>
            <h6 class="font-weight-bolder mb-0">Orders Report</h6>
          </nav>
                    ...
                    <table class="table align-items-center mb-0 text-center">
                      <thead>
                        <tr>
                          ...
                          <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-2">Orders Total</th>
                        </tr>
                      </thead>
                      <tbody>
                        @php
                        ...
                        <tr>
                          ...
                          <td>
                            ...
                            $amount = 0;
                            @endphp
                            @foreach($branch->orderitems as $item)
                              @php
