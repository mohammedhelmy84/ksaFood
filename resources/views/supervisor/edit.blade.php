        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="d-flex align-items-center user-member__title mb-30 mt-30">
                    <h4 class="text-capitalize">edit   branch</h4>
                </div>
            </div>
        </div>
                            ...
                            <div class="edit-profile__body">
                                <div class="form-group mb-25">
                                    ...
                                    <input type="text" class="form-control ih-medium ip-gray radius-xs b-light px-15"
                                        name="name" value="{{$supervisor->supervisor->name}}" id="name" placeholder="name">
                                    @if ($errors->has('name'))
                                ...
                                <div class="form-group mb-25">
                                    <label for="address" class="color-dark fs-14 fw-500 align-center">address<span
                                            class="text-danger">*</span></label>
                                    <input type="text" class="form-control ih-medium ip-gray radius-xs b-light px-15"
                                        name="address" id="address" value="  {{$supervisor->address}}"
                                        placeholder="address">
                                ...
                                <div class="form-group mb-25">
                                    <label for="phone" class="color-dark fs-14 fw-500 align-center">phone <span
                                            class="text-danger">*</span></label>
                                    <input type="text" class="form-control ih-medium ip-gray radius-xs b-light px-15"
                                        name="phone" value="{{$supervisor->supervisor->phone}}" id="phone" placeholder="phone">
                                    @if ($errors->has('phone'))
                                ...
                                <div class="form-group mb-25">
                                  <label for="phone" class="color-dark fs-14 fw-500 align-center">phone <span
                                          class="text-danger">*</span></label>
                                  <input type="text" class="form-control ih-medium ip-gray radius-xs b-light px-15"
                                      name="email" value="{{$supervisor->supervisor->email}}" id="phone" placeholder="phone">
                                  @if ($errors->has('phone'))
                                      <p class="text-danger">{{ $errors->first('phone') }}</p>
                                  @endif
                              </div>
                              ...
                              <div class="form-group mb-25">
                                ...
                                <select name="branch_name" id="branch_name" class="form-select">
                                    ...
                                    <option {{$branch->id == $supervisor->branch_id  ? 'selected' : '' }} value="{{ $branch->id  }}">{{ $branch->name }}</option>
                                    @endforeach
                                </select>
                            </div>
                                <div class="button-group d-flex pt-25 justify-content-md-end justify-content-start" style="margin-top: 30px;">
                                    <button type="submit"
                                        class="btn btn-primary btn-default btn-squared radius-md shadow2 btn-sm">Edit</button>
                                </div>
